  ...
  let mainIQueryForms: IQueryForm[] = [
    {
      ...
      sqlList: [
        ...
        },
        {
          ...
          sql: "SELECT * FROM TB_EMP WHERE DEPTNO IN (SELECT DEPTNO FROM TB_DEPT WHERE DNAME = :dname)",
        },
      ],
      state: "Active",
    },
      ...
      sqlList: [
        {
          ...
          sql: "SELECT * FROM TB_EMP WHERE DEPTNO IN (SELECT DEPTNO FROM TB_DEPT WHERE DNAME = :dname) AND JOB = :job",
        },
      ],
      state: "Active",
    },
